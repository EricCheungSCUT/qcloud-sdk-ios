...
@interface QCloudCOSXMLDemoTests : XCTestCase
...
- (void)setUp {
    ...
    self.appID =  @"1251668577";
    self.ownerID = @"2779643970";
}
...
- (void) testRegisterCustomService
{
    ...
    QCloudRegionType currentRegion;
    currentRegion = QCloudRegionCNSouth;
    configuration.regionType = currentRegion;
...
- (void) testGetACL {
    ...
    XCTAssert(policy.accessControlList.count == 1);
        XCTAssert([[policy.accessControlList firstObject].grantee.identifier isEqualToString:[NSString identifierStringWithID:@"1251668577" :@"1251668577"]]);
}
